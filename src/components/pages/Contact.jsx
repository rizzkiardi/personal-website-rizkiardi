    ...
    <div className="font-GeneralSans-Regular bg-transparent dark:bg-[#191919]">
      ...
      <main className="container max-w-6xl mx-auto">
        ...
        <div className="my-20 flex justify-center items-center">
          <div className="w-full max-w-lg mx-10 md:mx-0">
            <div className="my-14 md:my-10">
              <h2
                className="text-center scroll-m-20 text-3xl font-semibold tracking-tight first:mt-0 text-[#191919]/85 dark:text-[#e4e4e4]/80"
                data-aos="fade-up"
            ...
            <div
              ...
              data-aos-once="true"
            >
              <MagicCard className="rounded-md w-full max-w-md p-8 text-[#191919] mx-auto">
                <p className="leading-7 [&:not(:first-child)]:mt-6 mt-5 text-center text-[#191919]/85 dark:text-[#e4e4e4]/80">
