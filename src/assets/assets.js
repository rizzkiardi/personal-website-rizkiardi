...
import klinik_sanvita1 from "./images/klinik-sanvita-medika1.png";
import klinik_sanvita2 from "./images/klinik-sanvita-medika2.png";
...
export const projects = [
  {
    ...
    livePreview: "https://ppdb-smkvipmaarif.up.railway.app/",
  },
  {
    img: [
      assets.klinik_sanvita1,
      assets.klinik_sanvita2,
      assets.klinik_sanvita3,
      assets.klinik_sanvita4,
      assets.klinik_sanvita5,
    ],
    nameProjects: "Clinic Sanvita Medika",
    description:
      "Sanvita Medika Clinic is a modern healthcare facility offering general examinations, doctor consultations, and supporting medical services with professional standards and complete facilities to ensure patient comfort and health.",
    techStack: [
      "HTML5",
      "TailwindCSS",
      "TypeScript",
    ...
    linkGithub: "https://github.com/rizzkiardi/klinik-sanvita-medika",
    livePreview: "https://klinik-sanvita-medika.up.railway.app/",
  },
  {
    img: [assets.tokobit],
